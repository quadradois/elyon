...
router.get('/', async (req: Request, res: Response) => {
  try {
    ...
    return responderErro(res, 500, 'Erro ao listar alertas');
  }
});
...
router.get('/resumo', async (req: Request, res: Response) => {
  try {
    ...
    return responderErro(res, 500, 'Erro ao obter resumo de alertas');
  }
});
...
router.get('/:id', async (req: Request, res: Response) => {
  try {
    ...
    if (!alerta) {
      return responderErro(res, 404, 'Alerta não encontrado');
    }
    ...
    return responderErro(res, 500, 'Erro ao buscar alerta');
  }
});
...
router.patch('/:id/visualizar', async (req: Request, res: Response) => {
  try {
    ...
    return responderErro(res, 500, 'Erro ao visualizar alerta');
  }
});
...
router.patch('/:id/resolver', async (req: Request, res: Response) => {
  try {
    ...
    return responderErro(res, 500, 'Erro ao resolver alerta');
  }
});
...
router.post('/visualizar-todos', async (req: Request, res: Response) => {
  try {
    ...
    return responderErro(res, 500, 'Erro ao visualizar alertas');
  }
});
