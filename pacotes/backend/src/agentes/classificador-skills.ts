...
const GATILHOS: GatilhoSkill[] = [
    ...
    {
        id: 'prospeccao/protocolo-desconfianca',
        agentes: ['sdr'],
    ...
    {
        id: 'prospeccao/protocolo-recuo-hostilidade',
        agentes: ['sdr'],
    ...
    {
        id: 'prospeccao/tratativa-varios-corretores',
        agentes: ['sdr'],
    ...
    {
        id: 'prospeccao/protocolo-ja-tem-contrato',
        agentes: ['sdr'],
    ...
    {
        id: 'diagnostico/tratativa-exclusividade',
        agentes: ['sdr'],
    ...
    {
        id: 'diagnostico/tratativa-vender-sozinho',
        agentes: ['sdr'],
    ...
    {
        id: 'contrato/tratativa-clausulas',
        agentes: ['sdr'],
    ...
    {
        id: 'contrato/tratativa-condicoes',
        agentes: ['sdr'],
