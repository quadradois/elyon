...
Use quando o lead pedir explicação geral sobre cláusulas da autorização de venda:
...
1. Validar a dúvida em 1 linha.
2. Explicar cláusulas em blocos de benefício (segurança, transparência, previsibilidade).
3. Fechar com próximo passo objetivo (envio do modelo + alinhamento rápido).
