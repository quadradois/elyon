...
Checklist:
- dizer que o valor de anúncio é definido pelo proprietário;
- dizer que proposta inferior pode ser apresentada;
- reforçar que a decisão final é do proprietário;
...
Checklist:
- falar em mais alcance com parceiros;
- reforçar ausência de custo extra para o proprietário;
- citar que a comissão segue a cláusula 3;
- explicar que repasse ao parceiro é interno da operação;
...
Checklist:
- explicar comissão por intermediação/origem da operação;
- citar cliente ou corretor apresentado pela nossa atuação;
- deixar claro que venda fora da nossa intermediação após o prazo não gera obrigação;
- não usar tom de ameaça;
...
Checklist:
- falar em empresa 100% comprometida com a venda;
- reforçar delegação do operacional;
- dizer que o proprietário mantém a decisão final;
- destacar redução de desgaste, tempo e risco;
...
Checklist:
- dizer que cliente apresentado é cliente comunicado e identificado;
- reforçar proteção contra desacordo no fim da autorização;
- falar em transparência e atualização contínua ao proprietário;
- explicar que comissão depende de base rastreável;
...
- o prazo aplicado é o configurado no perfil da imobiliária;
...
Checklist:
- falar em média histórica/ciclo operacional, nunca em garantia;
- reforçar que resultado depende de preço, produto, demanda e execução;
- citar que o prazo vem do perfil da imobiliária;
- citar a revogação com aviso de 30 dias quando o lead perguntar sobre saída;
- não prometer venda em 6 meses como regra fixa;
- não transformar o argumento em debate estatístico longo.
