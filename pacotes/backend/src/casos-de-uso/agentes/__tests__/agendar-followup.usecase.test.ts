...
describe('AgendarFollowupUseCase', () => {
  ...
  it('usa o caminho explicito de reagendamento quando recebe followupId', async () => {
    ...
    const result = await new AgendarFollowupUseCase().execute({ tenantId: 't1', leadId: 'l1', followupId: 'followup-ativo', dataRecontato: '02/01/2027 09:00', timezoneIana: 'America/Sao_Paulo', motivo: 'Retorno reagendado', mensagemEnvio: 'Novo retorno confirmado', evidenciaPedido: 'pode me chamar dia 2', origemPedido: 'TOOL_AGENDAR_FOLLOWUP' });
