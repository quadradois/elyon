CREATE TABLE "followups_outbound" (
  ...
  "atualizadoEm" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP, "executadoEm" TIMESTAMP(3), "canceladoEm" TIMESTAMP(3),
...
CREATE INDEX "followups_outbound_status_agendadoParaUtc_proximoRetryEm_leaseAte_idx" ON "followups_outbound"("status", "agendadoParaUtc", "proximoRetryEm", "leaseAte");
