...
1. Preserve `EVOLUTION_API_URL`, `EVOLUTION_TENANT_API_KEY`,
   `EVOLUTION_TENANT_ID` e os tokens individuais das sessões no banco.
   O runtime Elyon não administra tenants e não requer a chave global.
